...
$consulta = "SELECT * FROM reporte_personal inner join personal on personal.id_pe = reporte_personal.id_reportado WHERE fecharepo_per BETWEEN '$fecha_de'and'$fecha_a'";
