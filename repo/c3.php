<?php
	...
	class PDF extends FPDF
	{
		function Header()
		{
			...
			$this->Cell(30);
			$this->Cell(220,10, 'Lista de Calentadores',0,0,'C');
			$this->Ln();
        ...
        { 
	     ...
	     function viewTable($db)
		 {
          ...
          $stmt = $db->query("SELECT id_c,turno_c,equipo_c,sistema_c,falla_c,refa_c,estado_c FROM calentadores INNER JOIN usuario ON calentadores.usuario_id=usuario.idusuario WHERE idusuario=3 AND DATE_FORMAT(fecha_c, '%Y-%m-%d') = CURDATE()");
