...
$consulta = mysql_query("SELECT turno_tp,id_tp,telar_tp FROM telar_planos INNER JOIN usuario ON telar_planos.usuario_id=usuario.idusuario WHERE idusuario=2 AND estado_tp='pendiente' AND DATE_FORMAT(fecha_tp, '%Y-%m-%d') = CURDATE()");
