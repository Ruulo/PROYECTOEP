<?php
	...
	class PDF extends FPDF
	{
		function Header()
		{
			...
			$this->Ln();
			$this->Cell(275,10,'Realizador por el Supervisor: Armado.Martinezs@bagcorp.com',0,0,'C');
			$this->Ln();
        ...
        { 
	     ...
	     function viewTable($db)
		 {
          ...
          $stmt = $db->query("SELECT id_p,turno_p,equipo_p,sistema_p,falla_p,refa_p FROM plegadores INNER JOIN usuario ON plegadores.usuario_id=usuario.idusuario WHERE idusuario=3 AND DATE_FORMAT(fecha_p, '%Y-%m-%d') = CURDATE()");
