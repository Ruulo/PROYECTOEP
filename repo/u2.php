	...
	class PDF extends FPDF
	{
        ...
        { 
	     ...
	     function viewTable($db)
		 {
          ...
          $stmt = $db->query("SELECT id_u,turno_u,equipo_u,sistema_u,falla_u,refa_u,estado_u FROM urdidor INNER JOIN usuario ON urdidor.usuario_id=usuario.idusuario WHERE idusuario=2 AND DATE_FORMAT(fecha_u, '%Y-%m-%d') = CURDATE()");
