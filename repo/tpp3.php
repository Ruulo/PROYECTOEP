<?php
	...
	class PDF extends FPDF
	{
		function Header()
		{
			...
			$this->Ln();
			$this->Cell(275,10,'Realizador por el Supervisor: Roberto.Torres@bagcorp.com',0,0,'C');
			$this->Ln();
        ...
        { 
	     ...
	     function viewTable($db)
		 {
          ...
          $stmt = $db->query("SELECT id_pp,turno_pp,telar_pp,estilo_pp,sistema_pp,falla_pp,com_pp,tipotelar_pp FROM telar_proceso INNER JOIN usuario ON telar_proceso.usuario_id=usuario.idusuario WHERE idusuario=3 AND DATE_FORMAT(fecha_pp, '%Y-%m-%d') = CURDATE()");
