	...
	class PDF extends FPDF
	{
        ...
        { 
	     ...
	     function viewTable($db)
		 {
          ...
          $stmt = $db->query("SELECT id_tc,turno_tc,equipo_tc,sistema_tc,falla_tc,refa_tc,estado_tc,estilo_tc FROM telar_circular INNER JOIN usuario ON telar_circular.usuario_id=usuario.idusuario WHERE idusuario=2 AND DATE_FORMAT(fecha_tc, '%Y-%m-%d') = CURDATE()");
