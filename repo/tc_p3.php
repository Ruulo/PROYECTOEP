...
$consulta = mysql_query("SELECT turno_tc,id_tc,equipo_tc FROM telar_circular INNER JOIN usuario ON telar_circular.usuario_id=usuario.idusuario WHERE idusuario=3 AND estado_tc='pendiente' AND DATE_FORMAT(fecha_tc, '%Y-%m-%d') = CURDATE()");
