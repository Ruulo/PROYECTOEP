	...
	class PDF extends FPDF
	{
        ...
        { 
	     ...
	     function viewTable($db)
		 {
          ...
          $stmt = $db->query("SELECT id_pp,turno_pp,telar_pp,estilo_pp,sistema_pp,falla_pp,com_pp,tipotelar_pp FROM telar_proceso INNER JOIN usuario ON telar_proceso.usuario_id=usuario.idusuario WHERE idusuario=2 AND DATE_FORMAT(fecha_pp, '%Y-%m-%d') = CURDATE()");
