	...
	class PDF extends FPDF
	{
        ...
        { 
	     ...
	     function viewTable($db)
		 {
          ...
          $stmt = $db->query("SELECT id_p,turno_p,equipo_p,sistema_p,falla_p,refa_p FROM plegadores INNER JOIN usuario ON plegadores.usuario_id=usuario.idusuario WHERE idusuario=2 AND DATE_FORMAT(fecha_p, '%Y-%m-%d') = CURDATE()");
