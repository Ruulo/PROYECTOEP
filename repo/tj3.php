	...
	class PDF extends FPDF
	{
        ...
        { 
	     ...
	     function viewTable($db)
		 {
          ...
          $stmt = $db->query("SELECT id_tj,turno_tj,equipo_tj,sistema_tj,falla_tj,refa_tj,estado_tj FROM telar_jareta INNER JOIN usuario ON telar_jareta.usuario_id=usuario.idusuario WHERE idusuario=3 AND DATE_FORMAT(fecha_tj, '%Y-%m-%d') = CURDATE()");
