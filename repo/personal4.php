...
$consulta = mysql_query("SELECT id_pe,turno_pe,nombre_pe,apellido_pe,com_pe FROM personal INNER JOIN usuario ON personal.usuario_id=usuario.idusuario WHERE idusuario=4 AND DATE_FORMAT(fecha_pe, '%Y-%m-%d') = CURDATE()");
