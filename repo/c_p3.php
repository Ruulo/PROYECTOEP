...
$consulta = mysql_query("SELECT turno_c,id_c,equipo_c FROM calentadores INNER JOIN usuario ON calentadores.usuario_id=usuario.idusuario WHERE idusuario=3 AND estado_c='pendiente' AND DATE_FORMAT(fecha_c, '%Y-%m-%d') = CURDATE()");
