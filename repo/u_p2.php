...
$consulta = mysql_query("SELECT turno_u,id_u,equipo_u FROM urdidor INNER JOIN usuario ON urdidor.usuario_id=usuario.idusuario WHERE idusuario=2 AND estado_u='pendiente' AND DATE_FORMAT(fecha_u, '%Y-%m-%d') = CURDATE()");
