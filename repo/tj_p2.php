...
$consulta = mysql_query("SELECT turno_tj,id_tj,equipo_tj FROM telar_jareta INNER JOIN usuario ON telar_jareta.usuario_id=usuario.idusuario WHERE idusuario=2 AND estado_tj='pendiente' AND DATE_FORMAT(fecha_tj, '%Y-%m-%d') = CURDATE()");
