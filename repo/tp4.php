<?php
	...
	class PDF extends FPDF
	{
        ...
        { 
		 ...
		 {
		  $this->SetFont('Arial','','8');
          $stmt = $db->query("SELECT id_tp,turno_tp,telar_tp,estilo_tp,sistema_tp,falla_tp,refa_tp,tipotelar_tp FROM telar_planos INNER JOIN usuario ON telar_planos.usuario_id=usuario.idusuario WHERE idusuario=4 AND DATE_FORMAT(fecha_tp, '%Y-%m-%d') = CURDATE()");
