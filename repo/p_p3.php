...
$consulta = mysql_query("SELECT turno_p,id_p,equipo_p FROM plegadores INNER JOIN usuario ON plegadores.usuario_id=usuario.idusuario WHERE idusuario=3 AND estado_p='pendiente' AND DATE_FORMAT(fecha_p, '%Y-%m-%d') = CURDATE()");
