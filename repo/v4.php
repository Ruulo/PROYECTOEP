	...
	class PDF extends FPDF
	{
        ...
        { 
	     ...
	     function viewTable($db)
		 {
          ...
          $stmt = $db->query("SELECT id_v,turno_v,equipo_v,sistema_v,falla_v,refa_v FROM vaporizador INNER JOIN usuario ON vaporizador.usuario_id=usuario.idusuario WHERE idusuario=4 AND DATE_FORMAT(fecha_v, '%Y-%m-%d') = CURDATE()");
