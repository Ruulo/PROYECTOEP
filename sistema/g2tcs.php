...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'TELAR CIRCULARES ESTADO PENDIENTE POR SEMANA'
        },
        subtitle: {
            text: ''
        },
        ...
        xAxis: {
            categories: [
			<?php
$sql_re=mysqli_query($conection,"SELECT  count(*) AS ESTADO, DATE_ADD(fecha_tc, INTERVAL 8-DAYOFWEEK(fecha_tc) DAY) SEMANA FROM telar_circular where estado_tc='Pendiente' AND DATE_FORMAT(fecha_tc, '%Y-%m-%d') = CURDATE()");
...
<a href="gmtcs.php" class="btn_new" >Siguiente <span class="fi fi-arrow-right"> </a></span></center>
