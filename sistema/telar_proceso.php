...
<b>TELARES EN PROCESO</h1></center></b>
        <hr>
    ...
    <div class="col-md-4">
	 ...
	 <div class="form-group">
          ...
          <textarea type="text" name="com_pp" class="form-control" placeholder="Escribe un comentario" autofocus></textarea>
		  	...
		  	<div class="form-group" id="Output"  name="tipotelar_pp" required>
...
<!--mostrar datos en tabla-->
       <?php
//paginador 
$sql_registe= mysqli_query($conection,"SELECT COUNT(*) as total FROM telar_proceso WHERE DATE_FORMAT(fecha_pp, '%Y-%m-%d') = CURDATE()");
...
$total_paginas =ceil($total /$por_pagina);
         ...
         $query = "SELECT * FROM telar_proceso WHERE DATE_FORMAT(fecha_pp, '%Y-%m-%d') = CURDATE() LIMIT $desde, $por_pagina";
