...
<?php
//paginador
$sql_registe= mysqli_query($conection,"SELECT COUNT(*) as total FROM plegadores WHERE MONTH(fecha_p)= MONTH(CURDATE())");
...
$total_paginas =ceil($total /$por_pagina);
         ...
         $query =mysqli_query($conection, "SELECT * FROM plegadores WHERE MONTH(fecha_p) = MONTH(CURDATE()) LIMIT $desde, $por_pagina");
