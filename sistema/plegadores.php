...
<b>TRANSPORTE DE PLEGADORES</h1></center></b>
        <hr>
...
<div class="right">
<center><input type="text" name="busqueda" id="busqueda" placeholder="buscar por estado.." >
...
<!--mostrar datos en tabla-->
         <?php
//paginador 
$sql_registe= mysqli_query($conection,"SELECT COUNT(*) as total FROM plegadores WHERE DATE_FORMAT(fecha_p, '%Y-%m-%d') = CURDATE()");
...
$total_paginas =ceil($total /$por_pagina);
         ...
         $query = "SELECT * FROM plegadores WHERE DATE_FORMAT(fecha_p, '%Y-%m-%d') = CURDATE() LIMIT $desde, $por_pagina";
          ...
          <tr>
            ...
            <td>
              <a href="editep.php?id_p=<?php echo $row['id_p']?>" class="link_edit"><h6>Editar
                ...
                <a href="../registros/plegadores.php"class="ver"><h6>Ver..
