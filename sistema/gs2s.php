...
$(function () {
    ...
    $('#container').highcharts({
        ...
        title: {
            text: 'TIPO DE FALLAS DE LOS TELARES EN PROCESO',
            x: -50
        },
        plotOptions: {
            series: {
        ...
        series: [{
			...
			<?php
			$sql_re=mysqli_query($conection,"select DISTINCT falla_f,id_f,estado_f from fallas order by falla_f desc");
			while($res=mysqli_fetch_array($sql_re)){
			?>

['<?php echo $res['falla_f'].' '.$res['id_f'] ?>', <?php echo $res['estado_f'] ?> ],
...
<br>
 <aside>
 		  <a href="gs2ces.php" class="btn_new" name="boton" value="Boton de color"   onClick="uno(this)"  ><span class="fi fi-graph-trend"> Cambio de Estilo</a></span>
		  <br>

		  <a href="gs2es.php" class="btn_new" name="boton" value="Boton de color"   onClick="dos(this)"  ><span class="fi fi-graph-trend"> En espera de trama</a></span>
<br>
  <a href="p1.php" class="btn_new" name="boton" value="Boton de color"   onClick="seis(this)"  ><span class="fi fi-graph-trend"> En espera de plegador</a></span>
  <br>
<a href="gs2fs.php" class="btn_new" name="boton" value="Boton de color"   onClick="tres(this)"  ><span class="fi fi-graph-trend"> Fuera de programa</a></span>
<br>
<a href="gs2as.php" class="btn_new"  name="boton" value="Boton de color"   onClick="cuatro(this)" ><span class="fi fi-graph-trend"> Por atar</a></span>
<br>
<a href="gs2ts.php" class="btn_new"  name="boton" value="Boton de color"   onClick="cinco(this)" ><span class="fi fi-graph-trend"> Por terminar</a></span>
 <br>
<!--<a href="gm2c.php" class="btn_1">Siguiente <span class="fi fi-arrow-right"></a></span>-->
<a href="a.php" class="btn_1"  name="boton"  ><span class="icon-logout"> Salir</a></span>
