...
$(function () {
    $('#container').highcharts({
        ...
        xAxis: {
            categories: [
			<?php
$sql_re=mysqli_query($conection,"select telar_pp,count(*) AS total from telar_proceso where tipotelar_pp='P7100' group by telar_pp");
...
<a href="P7100.php" class="btn_new" > Siguiente <span class="fi fi-arrow-right"></a></span></center>
