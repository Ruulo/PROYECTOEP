...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'URDIDOR ESTADO PENDIENTE POR SEMANA'
        },
        subtitle: {
            text: ''
        },
        ...
        xAxis: {
            categories: [
			<?php
$sql_re=mysqli_query($conection,"SELECT  count(*) AS ESTADO, DATE_ADD(fecha_u, INTERVAL 8-DAYOFWEEK(fecha_u) DAY) SEMANA FROM urdidor where estado_u='Pendiente' AND DATE_FORMAT(fecha_u, '%Y-%m-%d') = CURDATE()");
...
<a href="gmus.php" class="btn_new"> Siguiente <span class="fi fi-arrow-right"></a></span></center>
