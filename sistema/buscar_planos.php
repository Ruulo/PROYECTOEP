...
function Random_FUuNCTION()
		...
		///////////////////////////////////////////////////////////////////////////////////////////////////7
            ...
            function random_function()
            {
                ...
                {
                    var arr=["Transmisión", "Ajustes del plegador", "Engrane del plegador"];
                }
				//
	  ...
	  <div class="form-group">
          ...
          <textarea type="text" name="com_tp" class="form-control" placeholder="Escriba un comentario" autofocus></textarea>
          </div>
...
<div class="right">
<center><input type="text" name="busqueda" id="busqueda" placeholder="buscar por telar.." value="<?php echo $busqueda; ?>">
...
<!--mostrar datos en tabla-->
          <?php
//paginador 
$sql_registe= mysqli_query($conection,"SELECT COUNT(*) as total FROM telar_planos WHERE telar_tp LIKE '%$busqueda%'  AND DATE_FORMAT(fecha_tp, '%Y-%m-%d') = CURDATE()");
...
$total_paginas =ceil($total /$por_pagina);
          ...
          $query = "SELECT * FROM telar_planos WHERE telar_tp LIKE '%$busqueda%' AND DATE_FORMAT(fecha_tp, '%Y-%m-%d') = CURDATE()LIMIT $desde,$por_pagina";
