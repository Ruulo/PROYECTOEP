...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'TRANSPORTE DE PLEGADORES ESTADO PENDIENTE POR SEMANA'
        },
        subtitle: {
            text: ''
        },
        ...
        xAxis: {
            categories: [
			<?php
$sql_re=mysqli_query($conection,"SELECT  count(*) AS ESTADO, DATE_ADD(fecha_p, INTERVAL 8-DAYOFWEEK(fecha_p) DAY) SEMANA FROM plegadores where estado_p='Pendiente' AND DATE_FORMAT(fecha_p, '%Y-%m-%d') = CURDATE()");
...
<a href="gmps.php" class="btn_new">Siguiente <span class="fi fi-arrow-right"></a></span></center>
