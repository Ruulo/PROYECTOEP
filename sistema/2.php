...
<body>
 ...
 <center>
  <?php
			...
			$constulta = mysqli_query($conexion, "SELECT nombre from usuario where idusuario=2 ")
...
<?php
			...
			$constulta = mysqli_query($conexion, "SELECT id_pp , telar_pp FROM telar_proceso INNER JOIN usuario ON telar_proceso.usuario_id=usuario.idusuario where falla_pp='Por terminar'AND idusuario=2 AND DATE_FORMAT(fecha_pp, '%Y-%m-%d') = CURDATE()")
				or die ("Error al observar los registros");
...
<?php
			...
			$constulta = mysqli_query($conexion, "SELECT id_pp , telar_pp FROM telar_proceso INNER JOIN usuario ON telar_proceso.usuario_id=usuario.idusuario where falla_pp='Fuera de programa' AND idusuario=2 AND DATE_FORMAT(fecha_pp, '%Y-%m-%d') = CURDATE()")
				or die ("Error al observar los registros");
...
<?php
			...
			$constulta = mysqli_query($conexion, "SELECT id_pp , telar_pp FROM telar_proceso INNER JOIN usuario ON telar_proceso.usuario_id=usuario.idusuario where falla_pp='En espera de trama' AND idusuario=2 AND DATE_FORMAT(fecha_pp, '%Y-%m-%d') = CURDATE()")
				or die ("Error al observar los registros");
