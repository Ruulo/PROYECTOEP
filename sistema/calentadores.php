...
<b></span>CALENTADORES</h1></center></b>
        <hr>
    ...
    <div class="col-md-4">
      ...
      <div class="card card-body">
        <form action="gc.php" method="POST">
		 ...
		 <div class="form-group" id="output"  name="falla_c" required>
							</div>
...
<!--mostrar datos en tabla-->
          ...
          <?php
//paginador 
$sql_registe= mysqli_query($conection,"SELECT COUNT(*) as total FROM calentadores WHERE DATE_FORMAT(fecha_c, '%Y-%m-%d') = CURDATE()");
...
$total_paginas =ceil($total /$por_pagina);
         ...
         $query = "SELECT * FROM calentadores WHERE DATE_FORMAT(fecha_c, '%Y-%m-%d') = CURDATE() LIMIT $desde, $por_pagina";
