...
$(function () {
    $('#container').highcharts({
        ...
        series: [{
			...
			<?php
			$sql_re=mysqli_query($conection,"select  DISTINCT telar_pp  from telar_proceso where tipotelar_pp='TW-11 153'");
...
<a href="tp1.php" class="btn_new" ><span class="icon-logout"> Salir</a></span></center>
