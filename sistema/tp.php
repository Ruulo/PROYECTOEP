...
<br>
 <aside>
 		  <a href="g.php" class="btn_new" name="boton" value="Boton de color"   onClick="uno(this)"  ><span class="fi fi-graph-trend"> TW-11 130</a></span>
		  <br>

		  <a href="PS.php" class="btn_new" name="boton" value="Boton de color"   onClick="dos(this)"  ><span class="fi fi-graph-trend"> PS</a></span>
<br>
 <a href="P7.php" class="btn_new" name="boton" value="Boton de color"   onClick="seis(this)"  ><span class="fi fi-graph-trend"> P7300</a></span>
 <br>
<a href="153.php" class="btn_new" name="boton" value="Boton de color"   onClick="tres(this)"  ><span class="fi fi-graph-trend"> TW-11 153</a></span>
<br>
<a href="110.php" class="btn_new"  name="boton" value="Boton de color"   onClick="cuatro(this)" ><span class="fi fi-graph-trend"> TW-11 110</a></span>
<br>
<a href="220.php" class="btn_new"  name="boton" value="Boton de color"   onClick="cinco(this)" ><span class="fi fi-graph-trend"> TW220</a></span>
 <br>
<a href="P71.php" class="btn_new"  name="boton" value="Boton de color"   onClick="cinco(this)" ><span class="fi fi-graph-trend"> P7100</a></span>
 <br>
 <a href="PU.php" class="btn_new"  name="boton" value="Boton de color"   onClick="cinco(this)" ><span class="fi fi-graph-trend"> PU</a></span>
 <br>
...
function seis(Boton){
   if (!nav && Boton) Boton.style.backgroundColor="#b6447e" // color al pulsar
	...
	<h2><center><IMG SRC="../img/z.png" width="70%" height="50%" ><br></center>
