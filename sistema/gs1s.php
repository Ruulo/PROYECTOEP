...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'TELAR PLANOS ESTADO PENDIENTE POR SEMANA'
        },
        subtitle: {
            text: ''
        },
        ...
        xAxis: {
            categories: [
			<?php
$sql_re=mysqli_query($conection,"SELECT  count(*) AS ESTADO, DATE_ADD(fecha_tp, INTERVAL 8-DAYOFWEEK(fecha_tp) DAY) SEMANA FROM telar_planos where estado_tp='Pendiente' AND DATE_FORMAT(fecha_tp, '%Y-%m-%d') = CURDATE()");
...
<a href="gm1s.php" class="btn_new" > Siguiente <span class="fi fi-arrow-right"></a></span></center>
