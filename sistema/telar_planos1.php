...
<br>
<!--<a href="graficas1.php" class="btn_r" ><span class="icon-cancel"> Incidencias</a></span><!--botton del pdf-->
	 <!--termina el buscador-->
 <br>
...
<!--mostrar datos en tabla-->
          <?php
//paginador
$sql_registe= mysqli_query($conection,"SELECT COUNT(*) as total FROM telar_planos WHERE MONTH(fecha_tp) = MONTH(CURDATE())");
...
$total_paginas =ceil($total /$por_pagina);
          ...
          $query =mysqli_query($conection, "SELECT * FROM telar_planos WHERE MONTH(fecha_tp) = MONTH(CURDATE()) LIMIT $desde,$por_pagina");
