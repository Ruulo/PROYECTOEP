...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'TELAR DE JARETA ESTADO PENDIENTE POR SEMANA'
        },
        subtitle: {
            text: ''
        },
        ...
        xAxis: {
            categories: [
			<?php
$sql_re=mysqli_query($conection,"SELECT  count(*) AS ESTADO, DATE_ADD(fecha_tj, INTERVAL 8-DAYOFWEEK(fecha_tj) DAY) SEMANA FROM telar_jareta where estado_tj='Pendiente' AND DATE_FORMAT(fecha_tj, '%Y-%m-%d') = CURDATE()");
...
<a href="gmtjs.php" class="btn_new">Siguiente <span class="fi fi-arrow-right"></a></span></center>
