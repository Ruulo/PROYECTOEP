...
<!--<a href="graficas8.php" class="btn_r" ><span class="icon-cancel"> Incidencias</a></span><!--botton del pdf--> 
...
<!--mostrar datos en tabla-->
         <?php
//paginador 
$sql_registe= mysqli_query($conection,"SELECT COUNT(*) as total FROM vaporizador WHERE DATE_FORMAT(fecha_v, '%Y-%m-%d') = CURDATE()");
...
$total_paginas =ceil($total /$por_pagina);
         ...
         $query = "SELECT * FROM vaporizador WHERE DATE_FORMAT(fecha_v, '%Y-%m-%d') = CURDATE() LIMIT $desde, $por_pagina";
