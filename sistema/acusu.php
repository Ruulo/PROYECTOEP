...
<div class="container p-6">
  <div class="row">
    <div class="col-md-6 mx-auto">
      ...
      <form action="acusu1.php?idusuario=<?php echo $_GET['idusuario']; ?>" method="POST">
	...
	<div class="form-group">
          ...
          <input type="text" name="correo" class="form-control" value="<?php echo $correo; ?>" ></input>
          </div>
		  <div class="form-group">
		    <td><label><B>USUARIO:</B></label></td><td>
          <input type="text" name="usuario" class="form-control" value="<?php echo $usuario; ?>" ></input>
          </div>
		
		  
		   <div class="form-group">
		    <td><label><B>ROL</B></label></td><td>
            <input  type="text" name="rol" class="form-control" value="<?php echo $rol; ?>"></input>
		  </div>
