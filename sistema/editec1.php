...
if (isset($_POST['update'])) {
  ...
  $query = "UPDATE calentadores set  turno_c= '$turno_c',  sistema_c= '$sistema_c' ,falla_c= '$falla_c' , refa_c='$refa_c', estado_c='$estado_c', tipofalla_c='$tipofalla_c',com_c = '$com_c'  WHERE id_c=$id_c";
