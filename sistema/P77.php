...
$(function () {
    $('#container').highcharts({
        ...
        xAxis: {
            categories: [
			<?php
$sql_re=mysqli_query($conection,"select telar_pp,count(*) AS total from telar_proceso where tipotelar_pp='P7300' group by telar_pp");
...
<a href="P733.php" class="btn_new" > Siguiente <span class="fi fi-arrow-right"></a></span></center>
