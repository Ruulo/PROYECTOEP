...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'TELAR PROCESO FALLA "POR ATAR" POR SEMANA'
        },
        subtitle: {
            text: ''
        },
...
?>
        ...
        series: [{
			...
			<?php
$sql_re=mysqli_query($conection,"SELECT  count(*) AS ESTADO, DATE_ADD(fecha_pp, INTERVAL 8-DAYOFWEEK(fecha_pp) DAY) SEMANA FROM telar_proceso where falla_pp='Por atar' AND DATE_FORMAT(fecha_pp, '%Y-%m-%d') = CURDATE()");
while($res=mysqli_fetch_array($sql_re)){			
?>			
...
<a href="gmas.php" class="btn_new" > Siguiente <span class="fi fi-arrow-right"></a></span></center>
