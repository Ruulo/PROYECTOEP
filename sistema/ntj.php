...
<br>
<br>	   
        <h2><center><span class="fi-pencil" style=" font-size:0.9em; color:#000; text-shadow:1px 1px  #4cb6ea;"></span><b></span> REGISTRO TELARES DE JARETA</h2></center></b>
        <hr>
...
<div class="card card-body">
        <form action="ngtj.php" method="POST">
...
<center><button class="btn btn-primary"   name="ngtj"  value="Guardar"><span class="fi fi-save">  Guardar </span></button>
</center>
<br>
