...
<b>TELARES CIRCULARES</h1></center></b>
        <hr>
...
<!--mostrar datos en tabla-->
         <?php
//paginador 
$sql_registe= mysqli_query($conection,"SELECT COUNT(*) as total FROM telar_circular WHERE DATE_FORMAT(fecha_tc, '%Y-%m-%d') = CURDATE()");
...
$total_paginas =ceil($total /$por_pagina);
         ...
         $query = "SELECT * FROM telar_circular WHERE DATE_FORMAT(fecha_tc, '%Y-%m-%d') = CURDATE()LIMIT $desde, $por_pagina";
