...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'TIPOS DE TELARES TW-11 130'
        },
        subtitle: {
            text: ''
        },
        ...
        xAxis: {
            categories: [
			<?php
$sql_re=mysqli_query($conection,"select telar_pp,count(*) AS total from telar_proceso where tipotelar_pp='TW-11 130' group by telar_pp");
...
<a href="tww.php" class="btn_new"> Siguiente <span class="fi fi-arrow-right"></a></span></center>
