...
<br>
<br>	   
        <h2><center><span class="fi-pencil" style=" font-size:0.9em; color:#000; text-shadow:1px 1px  #4cb6ea;"></span><b> REGISTRO VAPORIZADOR/SISTEMA GAS</h2></center></b>
        <hr>
...
<div class="card card-body">
        <form action="ngv.php" method="POST">
         ...
         <div class="form-group">
		  ...
		  <td><label><B>SISTEMA:</B></label></td>
			 ...
			 <div class="form-group" id="output"  name="falla_v" required>
							</div>
          ...
          <textarea type="text" name="com_v" class="form-control" placeholder="Escriba un comentario" autofocus ></textarea>
          </div>
				
<center><button class="btn btn-primary"   name="ngv"  value="Guardar"><span class="fi fi-save">  Guardar </span></button>
</center>
<br>
