...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'TELAR PROCESO FALLA "FUERA DE PROGRAMA"  POR SEMANA'
        },
        subtitle: {
            text: ''
        },
...
<a href="gmfs.php" class="btn_new" > Siguiente <span class="fi fi-arrow-right"></a></span></center>
