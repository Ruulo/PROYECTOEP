...
<br>
<br>	   
           <h2><center><span class="fi-pencil" style=" font-size:0.9em; color:#000; text-shadow:1px 1px  #4cb6ea;"></span><b></span> REGISTRO USUARIO</h2></center></b></b>
        <hr>
...
<div class="card card-body">
        <form action="ngusu.php" method="POST">
         
          <div class="form-group">
		
		    <td><label><B>NOMBRE:</B></label></td><td>
          <input type="numeric" name="nombre" class="form-control" placeholder="Ingrese el nombres" autofocus></input>
          </div>
		  
          <div class="form-group">
		    <td><label><B>CORREO ELECTRÒNICO:</B></label></td><td>
          <input type="text" name="correo" class="form-control" placeholder="Ingrese el correo electrònico" autofocus></input>
          </div>
		  <div class="form-group">
		    <td><label><B>USUARIO:</B></label></td><td>
          <input type="text" name="usuario" class="form-control" placeholder="Ingrese el nombre de usuario" autofocus></input>
          </div>
		
		  
		   <div class="form-group">
		    <td><label><B>CLAVE</B></label></td><td>
            <input  type="text" name="clave" class="form-control" placeholder="Ingrese su clave" autofocus></input>
          </div>
...
<center><button class="btn btn-primary" name="ngusu"  value="Guardar"><span class="fi fi-save">  Guardar </span></button>
</center>
<br>
