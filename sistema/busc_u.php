...
<div class="right">
<input type="text" name="busqueda" id="busqueda" placeholder="buscar por estado.."  value="<?php echo $busqueda; ?>"> 
...
<!--mostrar datos en tabla-->
          <?php
//paginador 
$sql_registe= mysqli_query($conection,"SELECT COUNT(*) as total FROM urdidor WHERE estado_u LIKE '%$busqueda%' AND DATE_FORMAT(fecha_u, '%Y-%m-%d') = CURDATE()");
...
$total_paginas =ceil($total /$por_pagina);
         ...
         $query = "SELECT * FROM urdidor WHERE estado_u LIKE '%$busqueda%' AND DATE_FORMAT(fecha_u, '%Y-%m-%d') = CURDATE() LIMIT $desde, $por_pagina";
