...
if (isset($_POST['update'])) {
  ...
  $query = "UPDATE telar_circular set  turno_tc= '$turno_tc', equipo_tc = '$equipo_tc' , sistema_tc= '$sistema_tc' ,falla_tc= '$falla_tc' , refa_tc='$refa_tc', estado_tc='$estado_tc', com_tc = '$com_tc',estilo_tc='$estilo_tc'  WHERE id_tc=$id_tc";
