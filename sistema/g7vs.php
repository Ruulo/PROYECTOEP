...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'VAPORIZADOR ESTADO PENDIENTE POR SEMANA'
        },
        subtitle: {
            text: ''
        },
        ...
        xAxis: {
            categories: [
			<?php
$sql_re=mysqli_query($conection,"SELECT  count(*) AS ESTADO, DATE_ADD(fecha_v, INTERVAL 8-DAYOFWEEK(fecha_v) DAY) SEMANA FROM vaporizador where estado_v='Pendiente' AND DATE_FORMAT(fecha_v, '%Y-%m-%d') = CURDATE()");
...
<a href="gmvs.php" class="btn_new">Siguiente <span class="fi fi-arrow-right"></a></span></center>
