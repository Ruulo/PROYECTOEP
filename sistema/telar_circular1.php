...
<br>
<!--<a href="graficas13.php" class="btn_r" ><span class="icon-cancel"> Incidencias</a></span><!--botton del pdf-->
 <!--termina el buscador-->
	<br>
	<div class="left">
...
<!--mostrar datos en tabla-->
    <?php
//paginador
$sql_registe= mysqli_query($conection,"SELECT COUNT(*) as total FROM telar_circular WHERE MONTH(fecha_tc) = MONTH(CURDATE())");
...
$total_paginas =ceil($total /$por_pagina);
         ...
         $query =mysqli_query($conection, "SELECT * FROM telar_circular WHERE MONTH(fecha_tc) = MONTH(CURDATE()) LIMIT $desde, $por_pagina");
          ...
          <tr>
            ...
            <td>
			 <a href="actc.php?id_tc=<?php echo $data['id_tc']?>" class="link_edit"><h6>Editar
			   ...
			   <a href="elitc.php?id_tc=<?php echo $data['id_tc']?>" class="eli"><h6>Eliminar
