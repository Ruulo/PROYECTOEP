...
<!--<a href="graficas18.php" class="btn_r" ><span class="icon-cancel"> Incidencias</a></span><!--botton del pdf-->
   <!--termina el buscador-->
	 <br>
...
<!--mostrar datos en tabla-->
         <?php
//paginador
$sql_registe= mysqli_query($conection,"SELECT COUNT(*) as total FROM vaporizador WHERE MONTH(fecha_v) = MONTH(CURDATE())");
...
$total_paginas =ceil($total /$por_pagina);
         ...
         $query =mysqli_query($conection, "SELECT * FROM vaporizador WHERE MONTH(fecha_v) = MONTH(CURDATE()) LIMIT $desde, $por_pagina");
  ...
  $estado_color = array(
        'Terminado' => "#E7E0B2"
          ...
          <tr>
            ...
            <td>
			 <a href="acv.php?id_v=<?php echo $data['id_v']?>"class="link_edit"><h6>Editar
