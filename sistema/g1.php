...
<center><button type="button" value="Regresar" class="btn btn-primary tn-lg" id="regresar" onclick="history.back()" >
 ...
 <?php 
				if($_SESSION['rol'] ==2){
			 ?>
<a href="../repo/tp_m2.php" class="btn_r" ><span class="icon-download-alt"> </a></span></center><!--botton del pdf-->
     <?php } ?>
<?php 
				if($_SESSION['rol'] ==3){
			 ?>
<a href="../repo/tp_m3.php" class="btn_r" ><span class="icon-download-alt"> </a></span></center><!--botton del pdf-->
     <?php } ?>

<?php 
				if($_SESSION['rol'] ==4){
			 ?>
<a href="../repo/tp_m4.php" class="btn_r" ><span class="icon-download-alt"> </a></span></center><!--botton del pdf-->
     <?php } ?>
</body>
