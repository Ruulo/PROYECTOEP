<?php
	...
	*/
	...
	$aColumnas = array( 'id_c', 'turno_c', 'fecha_c', 'equipo_c','sistema_c','falla_c','refa_c','estado_c','tipofalla_c','com_c'  );
	...
	*/
	...
	while ( $aRow = $rResult->fetch_array())
	{
		...
		$row[] = "<td><a href='modificar.php?id_c=".$aRow['id_c']."'><span class=''></span></a></td>";
		$row[] = "<td><a href='#' data-href='eliminar.php?id_c=".$aRow['id_c']."' data-toggle='modal' data-target='#confirm-delete'><span class=''></span></a></td>";
