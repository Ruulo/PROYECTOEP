<?php
	...
	*/
	...
	/* Nombre de La Tabla */
	$sTabla = "telar_circular";
	
	/* Array que contiene los nombres de las columnas de la tabla*/
	$aColumnas = array( 'id_tc', 'turno_tc', 'fecha_tc', 'equipo_tc','sistema_tc','falla_tc','refa_tc','estado_tc','tipofalla_tc','com_tc','estilo_tc');
	...
	*/
	...
	while ( $aRow = $rResult->fetch_array())
	{
		...
		$row[] = "<td><a href='modificar.php?id_tc=".$aRow['id_tc']."'><span class=''></span></a></td>";
		$row[] = "<td><a href='#' data-href='eliminar.php?id_tc=".$aRow['id_tc']."' data-toggle='modal' data-target='#confirm-delete'><span class=''></span></a></td>";
