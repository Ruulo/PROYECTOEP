<?php
	...
	*/
	...
	$aColumnas = array( 'id_u', 'turno_u', 'fecha_u', 'equipo_u','sistema_u','falla_u','refa_u','estado_u','tipofalla_u','com_u'  );
	...
	*/
	...
	while ( $aRow = $rResult->fetch_array())
	{
		...
		$row[] = "<td><a href='modificar.php?id_u=".$aRow['id_u']."'><span class=''></span></a></td>";
		$row[] = "<td><a href='#' data-href='eliminar.php?id_u=".$aRow['id_u']."' data-toggle='modal' data-target='#confirm-delete'><span class=''></span></a></td>";
