<?php
	...
	*/
	...
	$aColumnas = array( 'id_pe', 'turno_pe','nombre_pe', 'apellido_pe', 'fecha_pe','com_pe' );
	...
	*/
	...
	while ( $aRow = $rResult->fetch_array())
	{
		...
		$row[] = "<td><a href='modificar.php?id_pe=".$aRow['id_pe']."'><span class=''></span></a></td>";
		$row[] = "<td><a href='#' data-href='eliminar.php?id_pe=".$aRow['id_pe']."' data-toggle='modal' data-target='#confirm-delete'><span class=''></span></a></td>";
