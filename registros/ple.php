<?php
	...
	*/
	...
	$aColumnas = array( 'id_p', 'turno_p', 'fecha_p', 'equipo_p','sistema_p','falla_p','refa_p','estado_p','tipofalla_p','com_p'  );
	...
	*/
	...
	while ( $aRow = $rResult->fetch_array())
	{
		...
		$row[] = "<td><a href='modificar.php?id_p=".$aRow['id_p']."'><span class=''></span></a></td>";
		$row[] = "<td><a href='#' data-href='eliminar.php?id_p=".$aRow['id_p']."' data-toggle='modal' data-target='#confirm-delete'><span class=''></span></a></td>";
