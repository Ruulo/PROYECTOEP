<?php
	...
	*/
	...
	$aColumnas = array( 'id_v', 'turno_v', 'fecha_v', 'equipo_v','sistema_v','falla_v','refa_v','estado_v','tipofalla_v','com_v');
	...
	*/
	...
	while ( $aRow = $rResult->fetch_array())
	{
		...
		$row[] = "<td><a href='modificar.php?id_v=".$aRow['id_v']."'><span class=''></span></a></td>";
		$row[] = "<td><a href='#' data-href='eliminar.php?id_v=".$aRow['id_v']."' data-toggle='modal' data-target='#confirm-delete'><span class=''></span></a></td>";
