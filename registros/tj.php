<?php
	...
	*/
	...
	$aColumnas = array( 'id_tj', 'turno_tj', 'fecha_tj', 'equipo_tj','sistema_tj','falla_tj','refa_tj','estado_tj','tipofalla_tj','com_tj'  );
	...
	*/
	...
	while ( $aRow = $rResult->fetch_array())
	{
		...
		$row[] = "<td><a href='modificar.php?id_tj=".$aRow['id_tj']."'><span class=''></span></a></td>";
		$row[] = "<td><a href='#' data-href='eliminar.php?id_tj=".$aRow['id_tj']."' data-toggle='modal' data-target='#confirm-delete'><span class=''></span></a></td>";
