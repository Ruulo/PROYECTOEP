<?php
	...
	*/
	...
	$aColumnas = array( 'id_tp', 'turno_tp', 'fecha_tp', 'telar_tp','estilo_tp','sistema_tp','falla_tp','refa_tp','estado_tp','tipofalla_tp','com_tp','tipotelar_tp' );
	...
	*/
	...
	while ( $aRow = $rResult->fetch_array())
	{
		...
		$row[] = "<td><a href='modificar.php?id_tp=".$aRow['id_tp']."'><span class=''></span></a></td>";
		$row[] = "<td><a href='#' data-href='eliminar.php?id_tp=".$aRow['id_tp']."' data-toggle='modal' data-target='#confirm-delete'><span class=''></span></a></td>";
