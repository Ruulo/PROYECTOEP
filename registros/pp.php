<?php
	...
	*/
	...
	/* Nombre de La Tabla */
	$sTabla = "telar_proceso";
	
	/* Array que contiene los nombres de las columnas de la tabla*/
	$aColumnas = array( 'id_pp', 'turno_pp', 'fecha_pp', 'telar_pp','estilo_pp','sistema_pp','falla_pp','tipofalla_pp','com_pp','tipotelar_pp');
	...
	*/
	...
	while ( $aRow = $rResult->fetch_array())
	{
		...
		$row[] = "<td><a href='modificar.php?id_pp=".$aRow['id_pp']."'><span class=''></span></a></td>";
		$row[] = "<td><a href='#' data-href='eliminar.php?id_pp=".$aRow['id_pp']."' data-toggle='modal' data-target='#confirm-delete'><span class=''></span></a></td>";
